using Freelancer.Repository;
using Freelancer.Repository.Base;
using Freelancer.UnitOfwork;
...
namespace Freelancer.Services.Base
{
    public abstract class ServiceBase<TEntity> : IDisposable where TEntity : class, new()
    {
        ...
        //public virtual  GetEntityIdQuery(Expression<Func<TEntity, bool>> predicate)
        //{
        //    try
        //    {
        //        return repository.GetEntityIdQuery(predicate);
        //    }
        //    catch (Exception exc)
        //    {
        //        throw exc;
